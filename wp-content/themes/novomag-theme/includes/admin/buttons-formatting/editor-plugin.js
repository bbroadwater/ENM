...
var orangethemesButtons=[
		{
			...
			fields:[{id:'text', name:'Text'},{id:'icon', name:'Icon', values:ot_icons()},{id:'href', name:'Link URL'},{id:'color', name:'Color', value:'b70900', colorpalette:true},{id:'textcolor', name:'Text Color', colorpalette:true},{id:'target', name:'Target', values:['Self', 'Blank']},{id:'side', name:'Icon Side', values:['Left', 'Right']}],
			generateHtml:function(obj){
				var code = obj.icon;
				var buttonTarget=obj.target==='Self'?'':'blank';
				return '[button link="'+obj.href+'" icon="'+code+'" side="'+obj.side.toLowerCase()+'" target="'+buttonTarget+'" color="'+obj.color.toLowerCase()+'" textcolor="'+obj.textcolor.toLowerCase()+'"]'+obj.text+'[/button]';
		...
		},		
		{
			...
			title:'Spacer',
			allowSelection:false,
			fields:[{id:'style', name:'Style', values:['Spacer 1', 'Spacer 2', 'Spacer 3']},{id:'icon', name:'Icon', values:ot_icons()},{id:'color', name:'Color (Spacer 2 & Spacer 3 Only)', value:'8BC234', colorpalette:true}],
			generateHtml:function(obj){
				...
				return '[spacer color="'+obj.color+'" icon="'+obj.icon+'" style="'+spacerStyle+'"]';
		...
		},
		{
			...
			title:'Quote',
			allowSelection:false,
			fields:[{id:'style', name:'Style', values:['Style-1', 'Style-2', 'Style-3', 'Style-4']},{id:'quotetext', name:'Quote text', textarea:true}],
			generateHtml:function(obj){
		...
		},
		{
			...
			title:'Alert Box',
			allowSelection:false,
			fields:[{id:'text', name:'Text', textarea:true},{id:'color', name:'Color', color:"c24000", colorpalette:true}],
			generateHtml:function(obj){
	                ...
	                onclick : function() {
	                   ...
	                   if(btn.allowSelection && selection && btn.fields){
						...
						jQuery("#orangethemes-shortcode-style").change(function () {
						    if (jQuery(this).val() == 'Spacer 3' || jQuery(this).val() == 'Spacer 4') {

...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	function orange_themes_scripts() { 
		...
		wp_enqueue_style("owl-carousel", THEME_CSS_URL."owl.carousel.css", Array());
		...
		wp_enqueue_script(THEME_JS_URL."-scripts" , THEME_JS_URL."theme-scripts.js", Array('jquery'), "1.5.19", true);
		...
		wp_enqueue_script("nicescroll" , THEME_JS_URL."jquery.nicescroll.min.js", Array('jquery'), '', true);
		wp_enqueue_script("owl-carousel" , THEME_JS_URL."owl.carousel.min.js", Array('jquery'), '', true);

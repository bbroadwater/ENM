...
function OT_fields_rules($fields) {
	$fields['rules'] = '<p class="contact-info"><i class="fa fa-info"></i>'.__("Your e-mail address will not be published.", THEME_NAME).'<br/>'.__("Required fields are marked", THEME_NAME).'<span class="required">*</span></p>';
	print $fields['rules'];
}

		...
		<?php woo_post_before(); ?>
            ...
            <?php } else { ?>
                ...
                <?php while ( have_posts() ) { the_post(); ?>
                		...
                		<?php } ?>
<?php /*?>
                 //MOUSE MEDIA REMOVING THE EMAIL NOT CONFIGURED ALERT  <?php if( isset( $hasError ) || isset( $captchaError ) ) { ?>
...
<?php */?>
                    ...
                    <!-- COMMENT ADDED BY MOUSE MEDIA TO REMOVED FORM BUT TO KEEP MAP FUNCTIONALITY FROM WOOTHEMES OPTIONS  <form action="<?php the_permalink(); ?>" id="contactForm" method="post">

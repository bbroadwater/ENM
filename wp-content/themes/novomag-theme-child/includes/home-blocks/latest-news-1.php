                ...
                <div class="article-list">
                            ...
                            <div class="article-slide">
                                ...
                                <a href="<?php the_permalink();?>" class="info-line">
                                    ...
                                    <?php if($postAuthor=="on") { ?>
                                        <span><?php _e("by", THEME_NAME); echo " ".get_the_author();?></span>
                                    <?php } ?>
                    ...
                    <div class="item">
                        ...
                        <div class="item-content">
                            ...
                            <?php } ?>
                            <?php if($postAuthor=="on") { ?>
                                        <?php _e("&nbsp;|&nbsp;by", THEME_NAME); echo " ".get_the_author();?></span>
                                    <?php } ?>
                            
                            <?php if ( comments_open() && $postComments=="on") { ?>
                                <a href="<?php the_permalink();?>#comments"><span><?php comments_number(__("0 Comments", THEME_NAME),__("1 Comment", THEME_NAME),__("% Comments", THEME_NAME)); ?></span></a>
                            <?php } ?>

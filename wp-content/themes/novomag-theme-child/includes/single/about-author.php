	...
	<div class="panel">
		...
		<div class="about-author">
			<div class="about-header">
				...
				<!-- <img src="<?php// echo get_avatar_url(get_avatar( get_the_author_meta('user_email',$user_ID), 100));?>" class="about-avatar" alt="<?php// echo get_the_author_meta('display_name',$user_ID); ?>" />-->
				</a>
			</div>
